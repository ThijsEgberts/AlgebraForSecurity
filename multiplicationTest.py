...
class TestMultiplicationOperations(unittest.TestCase):
    ...
    def run_test_cases(self, multiplication_function):
        ...
        # Test case 5: Multiplication of differen modulo numbers
        # TODO dit is moeilijk :o
        # x = createBigNumberFromExponents(14, [12, 1, 14], 0)
        # y = createBigNumberFromExponents(14, [11, 13, 9], 0)
        # result = solve_multiplication_primary(x, y)
