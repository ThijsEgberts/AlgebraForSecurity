...
class TestBigNumberOperations(unittest.TestCase):
    ...
    def test_addition_integer_arithmetic(self):
        ...
        x = BigNumber(10, [3, 2, 1], 0)
        y = BigNumber(10, [2, 1, 0], 0)
