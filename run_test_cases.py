...
def runSimpleFFdivision():
    ...
    solve.solve_exercise("exercises\Simple\Exercises\exercise14.json",
                         "exercises\Simple\Answers\\answer14.json", False)
    
def runSimpleFFinversion():
    solve.solve_exercise("exercises\Simple\Exercises\exercise15.json",
                         "exercises\Simple\Answers\\answer15.json", False)
    
def runSimpleFFPrimitivityCheck():
    solve.solve_exercise("exercises\Simple\Exercises\exercise16.json",
                         "exercises\Simple\Answers\\answer16.json", False)
    
def runSimpleFFPrimitiveGenerator():
    solve.solve_exercise("exercises\Simple\Exercises\exercise17.json",
                         "exercises\Simple\Answers\\answer17.json", False)
